...
환경변수 관리가 조금 어려웠습니다. 모든 설정을 git에 둬야하는데, DB비밀번호 같은 민감 정보를 git repository에 저장할 수가 없었습니다. 다양한 방식을 검토했고, AWS Secrets Manager를 사용한 방식과 Sealed Secret 방식을 알게됐습니다. 그리고 그 중에 kubernetes에 쉽게 통합할 수 있는 Sealed Sc
