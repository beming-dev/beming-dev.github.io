...
여러 서비스를 개바코드 레벨에서 아키텍처 설계가 코드 간 의존성을 줄여 개발 비용이 감소하는 것을 경험했고, 인프라 레벨에서 설계한 아키텍처가 서비스 안정성에 도움을 주고, CI/CD파이프 라인이 개발에 집중할 수 있는 환경을 만들어주는것을 경험했습니다. 이러한 경험들로 코드 개발과 아키텍처 모두에 관심을 가지고 있습니다.
