...
가장 먼저, 비즈니스 도메인을 파악하는 것이 중요하다고 생각합니다. 레거시 시스템의 코드는 스파게티 처럼 얽혀 있을 것입니다. MSA의 핵심은 서비스를 '비즈니스 기능' 단위로 분리하는 것입니다. 도메인 주도 개발의 바운디드 컨텍스트 개념을 활용하여, 각 도메인을 정의하고 도메인 단위로 서비스를 분리할 것 같습니다.
