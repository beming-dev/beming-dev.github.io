...
먼저, 저는 개발과 아키텍처 두 가지 모두에 관심이 있습니다. 서비스를 운영하며, 코드 레벨에서 코드 아키텍처의 중요성과 인프라 수준에서 아키텍처 설계의 중요성 모두 느꼈기 때문입니다. 
최근에 AI가 급격히 발달하면서, 직접 코드를 타이핑 하는 일이 많이 줄었습니다. 특히, CI/CD같은 서비스의 인프라 구조, 그리고 코드 아키텍처 레벨에서 코드의 구조를 잘 잡아놓으면, 개발 생산성이 훨씬 증가한다고 생각합니다.
