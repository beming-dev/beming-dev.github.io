...
저는 개발자로서 **'견고한 설계'**와 **'안정적 운영'**이라는 두 가지 축을 중심으로 역량을 쌓아왔습니다. 클린 아키텍처와 DDD를 적용하며 **유지보수성이 높은 코드**를 고민했고, Heroku에서 AWS로 서비스를 이전하며 **CI/CD 파이프라인 구축과 비용 최적화**를 달성했습니다.

특히, 잦은 서버 다운 문제를 해결하기 위해 ELK 스택을 도입하던 중, **메모리 이슈를 Filebeat로 대체하여 최적화**한 경험은 **'주도적으로 문제를 해결'**하는 저의 강점을 보여줍니다.

LG CNS는 수십 년간의 IT 시스템 구축 경험이라는 **'안정성'**과 클라우드/AI로 DX를 이끄는 **'혁신성'**을 모두 갖춘 곳입니다. 제가 쌓아온 설계, 운영, 그리고 신기술(K8s, ArgoCD) 학습 역량을 바탕으로, 고객의 비즈니스 요구에 맞는 **최적의 클라우드 아키텍처를 설계**하는 전문가로 LG CNS와 함께 성장하겠습니다
